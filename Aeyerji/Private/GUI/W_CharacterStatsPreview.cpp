    ...
    : Super(ObjectInitializer)
{
    if (Rows.Num() == 0)
    {
        Rows = {
            ...
            MakeRow(LOCTEXT("PoisonAmount", "Poison Amount"), UAeyerjiAttributeSet::GetPoisonAmountAttribute(), 1, false, true),
            MakeRow(LOCTEXT("PoisonDuration", "Poison Duration"), UAeyerjiAttributeSet::GetPoisonDurationAttribute(), 1, false, true),
            MakeRow(LOCTEXT("TraumaAmount", "Trauma Amount"), UAeyerjiAttributeSet::GetTraumaAmountAttribute(), 1, false, true),
            MakeRow(LOCTEXT("TraumaDuration", "Trauma Duration"), UAeyerjiAttributeSet::GetTraumaDurationAttribute(), 1, false, true),
            MakeRow(LOCTEXT("CorruptionAmount", "Corruption Amount"), UAeyerjiAttributeSet::GetCorruptionAmountAttribute(), 1, false, true),
            MakeRow(LOCTEXT("CorruptionDuration", "Corruption Duration"), UAeyerjiAttributeSet::GetCorruptionDurationAttribute(), 1, false, true),
            MakeRow(LOCTEXT("SpellPower", "Spell Power"), UAeyerjiAttributeSet::GetSpellPowerAttribute()),
            MakeRow(LOCTEXT("MagicAmp", "Magic Amp"), UAeyerjiAttributeSet::GetMagicAmpAttribute(), 1),
