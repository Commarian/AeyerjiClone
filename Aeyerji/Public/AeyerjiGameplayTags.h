...
namespace AeyerjiTags
{
	...
	AEYERJI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Primary_Ranged_Bombardment);
	AEYERJI_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Enemy_Role_Mob_Ranged_Bombardier);
